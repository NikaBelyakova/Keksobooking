...
function createAdCard(ad) {
  ...
  ad.offer.address ? cardElement.querySelector('.popup__text--address').textContent = ad.offer.address : cardElement.querySelector('.popup__text--address').remove();
  ...
  ad.author.avatar ? cardElement.querySelector('.popup__avatar').src = ad.author.avatar : cardElement.querySelector('.popup__avatar').remove();
